...
// an input and returns true or false based on whether
// an input is not a string. Numeric strings will
// count as strings and should return false.
...
// takes in a value and returns a boolean if
// the argument provided is an empty string or not.
...
// Define a function named isANumber that takes
//in a value and returns true if the input is a number.
...
// Define a function named isNumeric that takes in
// a value and returns true if the input is numeric
// or not. Numeric strings are numeric and should return true.
...
// Define a function named isZero that will
// return true when passed an argument of the
...
// Define a function named isMoreThanTen that accepts
// a number and returns true or false based on
// whether the input is more than ten.
...
// an input and returns true or false based on whether
// the input is above zero. Any non-numeric input should return false.
