...
// Define a function named isString that takes in a
// value and returns a boolean if the argument
// provided is a string or not.
...
// Define a function named isNotString that accepts
// an input and returns true or false based on
// whether an input is not a string. Numeric strings
// will count as strings and should return false.
...
// Define a function named isNotEmptyString that
// takes in a value and returns a boolean if the
// argument provided is an empty string or not.
    function isNotEmptyString( x) {
        return (x !== "string" && x.length > 0);
    }
...
// Define a function named isANumber that takes in
// a value and returns true if the input is a number.
...
// Define a function named isNumeric that takes
// in a value and returns true if the input is
// numeric or not. Numeric strings are numeric
...
// Define a function named isZero that will return
// true when passed an argument of the numeric
// value 0, and return false for all other arguments.
function isZero(x) {
    var y = parseInt(x);
    return (y === 10);
}
...
// Define a function named isMoreThanTen that
// accepts a number and returns true or false
// based on whether the input is more than ten.
...
// Define a function named isPositive that accepts
// an input and returns true or false based on
// whether the input is above zero. Any non-numeric
